...
TIMESTAMP: 타임존-UTC / 시간차이 한국시간-9시간  
DATETIME: 타임존-T(time) / 시간차이 한국zone 사용 시 한국 시간과 동일  
...
DATE과 HOUR만 남기고 싶은 경우  
DATEIME_TRUNC(dateime_col, HOUR)   

문자열로 저장된 DATETIME을 DATETIME타입으로 바꾸는 경우   
